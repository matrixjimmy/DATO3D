...
import com.anhe3d.EclipsePattern2GenerateModel;
 ...
 */
@Slf4j
public class EclipsePattern2AutoPrintScheduledTask extends TimerTask {
    ...
    @Inject
    public EclipsePattern2AutoPrintScheduledTask(long counterLimit, long initialESteps, SerialService serialService, PrintService printService, EclipsePattern2GenerateModel model) {
        ...
        gc.fillOval(260 + model.getX() - 0.5 * model.getR(), 580 + model.getY() - 0.5 * model.getH(), model.getR(), model.getH());
    }
