...
public class EclipsePattern2GenerateView extends AbstractJavaFXGriffonView {
    @MVCMember
    @Nonnull
    ...
    @MVCMember
    @Nonnull
    private EclipsePattern2GenerateController controller;
    ...
    @FXML
    private TextField inputXActionTarget, inputYActionTarget, inputRActionTarget, inputHActionTarget, inputInitialEActionTarget, inputD1ActionTarget, inputD2ActionTarget;
    ...
    @MVCMember
    public void setController(@Nonnull EclipsePattern2GenerateController controller) {
    ...
    public void initUI() {
        ...
        labelX.setText(getApplication().getMessageSource().getMessage("EclipsePattern2Generator.action.LabelX.text"));
        labelY.setText(getApplication().getMessageSource().getMessage("EclipsePattern2Generator.action.LabelY.text"));
        labelR.setText(getApplication().getMessageSource().getMessage("EclipsePattern2Generator.action.LabelR.text"));
        labelH.setText(getApplication().getMessageSource().getMessage("EclipsePattern2Generator.action.LabelH.text"));
        labelD1.setText(getApplication().getMessageSource().getMessage("EclipsePattern2Generator.action.LabelD1.text"));
        labelD2.setText(getApplication().getMessageSource().getMessage("EclipsePattern2Generator.action.LabelD2.text"));
